...
<template>
  <aside class="flex flex-col w-64 border-r bg-dark-800 border-dark-600">
    <div class="flex items-center px-6 h-14 border-b titlebar-drag border-dark-600">
      <div class="flex gap-3 items-center titlebar-no-drag">
        <div class="flex justify-center items-center w-8 h-8 bg-gradient-to-br rounded-lg from-claw-400 to-claw-600">
        ...
        <li v-for="item in menuItems" :key="item.id">
          ...
          >
            <div
              ...
              :enter="{ opacity: 1, x: 0 }"
              :duration="200"
              class="absolute left-0 top-1/2 w-1 h-6 rounded-r-full -translate-y-1/2 bg-claw-500"
            />
            <component
              :is="item.icon"
              :size="18"
    ...
    <div class="p-4 border-t border-dark-600">
      <div class="px-4 py-3 rounded-lg bg-dark-700">
